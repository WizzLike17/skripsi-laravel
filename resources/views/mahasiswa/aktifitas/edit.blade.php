        ...
        <div class="col-lg-10 mx-auto">
            <div class="card border-0 shadow rounded-3">
                <div class="card-header bg-secondary text-white">
                    <h5 class="mb-0"><i class="bx bx-edit me-2"></i>Edit Pengajuan Aktifitas</h5>
                </div>
                <div class="card-body mt-3">
                    ...
                    <div class="row">
                        {{-- Kolom Form --}}
                        @include('mahasiswa.sertifikat.aktifitas', ['aktifitas' => $aktifitas])

                        {{-- Kolom Detail --}}

                        <div class="col-md-4">
                            @if ($aktifitas->sertifikatRel && $aktifitas->sertifikatRel->revisi_alasan)
                                <div class="card shadow-sm border-0 mb-3" style="border-radius: 1rem; overflow: hidden;">
                                    ...
                                    <div class="card-body" style="background-color: #f8f9fa;">
                                        <p class="mb-0 text-dark" style="white-space: pre-wrap;">
                                            {{ $aktifitas->sertifikatRel->revisi_alasan }}
                                        </p>
                                    </div>
                                </div>
                            @else
