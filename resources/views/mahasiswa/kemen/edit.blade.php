...
@section('title', 'Edit Kemendikbud')
        ...
        <div class="col-lg-10 mx-auto">
            <div class="card border-0 shadow rounded-3">
                <div class="card-header bg-secondary text-white">
                    <h5 class="mb-0"><i class="bx bx-edit me-2"></i>Edit Pengajuan Kemendikbud</h5>
                </div>
                ...
                <div class="card-body mt-3">
                    ...
                    <div class="row">
                        {{-- Form kiri --}}
                        @include('mahasiswa.sertifikat.kemendikbud', ['kemendikbud' => $kemendikbud])

                        {{-- Detail kanan --}}

                        <div class="col-md-4">
                            @if ($kemendikbud->sertifikatRel && $kemendikbud->sertifikatRel->revisi_alasan)
                                <div class="card shadow-sm border-0 mb-3" style="border-radius: 1rem; overflow: hidden;">
                                    ...
                                    <div class="card-body" style="background-color: #f8f9fa;">
                                        <p class="mb-0 text-dark" style="white-space: pre-wrap;">
                                            {{ $kemendikbud->sertifikatRel->revisi_alasan }}
                                        </p>
                                    </div>
                                </div>
                            @else
