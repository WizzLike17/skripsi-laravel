...
class MbkmController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('daftar')->with('success', 'Pengajuan MBKM berhasil disimpan dan sertifikat dibuat.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('daftar')->with('success', 'Data MBKM berhasil diperbarui dan status dikembalikan ke pending.');
    }
}
